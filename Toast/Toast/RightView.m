...
- (void)drawRect:(CGRect)rect {
    ...
    [aPath moveToPoint:CGPointMake(12.0, 18.0)];
    // Draw the lines
    [aPath addLineToPoint:CGPointMake(18.0, 25.0)];
    ...
    [twoPath moveToPoint:CGPointMake(18.0, 25.0)];
    [twoPath addLineToPoint:CGPointMake(30.0, 15.2)];
    [twoPath closePath];
    [twoPath stroke];
